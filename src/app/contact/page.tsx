  ...
  return (
    <main className="min-h-[100svh] w-full bg-white text-slate-900">
      <header className="relative isolate min-h-[100svh] overflow-hidden">
        <div className="absolute inset-0 -z-20 bg-[radial-gradient(1400px_760px_at_20%_-10%,rgba(25,195,255,0.55),rgba(6,42,68,0)_62%),radial-gradient(1100px_660px_at_85%_10%,rgba(18,167,255,0.50),rgba(6,42,68,0)_60%),linear-gradient(to_bottom,rgba(6,42,68,0.90),rgba(6,42,68,0.90))]" />
        <div className="absolute inset-0 -z-10 opacity-70 bg-[url('/images/img17.jpg')] bg-cover bg-center" />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,rgba(6,42,68,0.15),rgba(6,42,68,0.35))]" />
        ...
        <div className="mx-auto flex min-h-[100svh] max-w-7xl flex-col px-6 pb-20 pt-28 lg:px-8 lg:pt-32">
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <p className="mt-4 text-pretty text-base leading-7 text-white/85 sm:text-lg">
              Call/text us anytime, or send a message below and we’ll reply fast
              with availability and booking steps.
            </p>
          </div>
        </div>
