...
export function BiminiDayCta() {
  return (
    <RevealSection className="group relative isolate w-full overflow-hidden -mt-px">
      <div className="absolute inset-0 -z-20 bg-[url('/images/new0.jpeg')] bg-cover bg-center motion-safe:transition-transform motion-safe:duration-[900ms] motion-safe:ease-out motion-safe:group-hover:scale-105" />
