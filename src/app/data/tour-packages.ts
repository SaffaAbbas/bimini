...
export const tourPackages: TourPackage[] = [
  ...
  },
  {
    ...
    imageAlt: "Guests enjoying a North and South Bimini island tour on the water",
    duration: "4 hours",
    priceLines: [
      "Adults: $200 + VAT",
      "Kids: $150 + VAT",
    ...
    description:
      "North Bimini culture, the famous Fountain of Youth on South Bimini, Shark Lab viewpoint, round-trip ferry, and lunch on the south side—all in one island-hopping day.",
    inclusions: [
      "Round-trip ferry (North ↔ South)",
      "North Bimini culture & landmark stops",
      "Fountain of Youth (South Bimini)",
      "Shark Lab viewpoint / stop when available",
      "Lunch on South Bimini (local restaurant)",
      "Beach free time",
    ],
    locationLabel: "Bimini, Bahamas",
    meetingPoint: "Ferry dock / tour start — detailed in confirmation.",
    overviewParagraphs: [
      "Explore North and South Bimini in one unforgettable outing—including the scenic ferry ride between islands.",
      "On North Bimini, visit favorites like Stuart's Conch Stand, Nate's Bakery, the Craft Center, and the Dolphin House Museum with stories from your local guide.",
      "On South Bimini, see the famous Fountain of Youth—a legendary stop guests ask for by name—and take in the Shark Lab (Bimini Biological Field Station) when schedules allow.",
      "Lunch is served on the south side at a local restaurant (Bahamian flavors, sit-down meal), with time to relax on the beach before heading back.",
    ],
    experienceHighlights: [
      "North Bimini food & culture stops",
      "Fountain of Youth on South Bimini",
      "Shark Lab viewpoint when available",
      "Lunch on the south side",
      "Round-trip ferry + beach time",
    ],
    includesChecklist: [
      "Round-trip North ↔ South ferry",
      "Guided tour on both islands",
      "Fountain of Youth stop",
      "Lunch on South Bimini",
      "Beach relaxation time",
    ],
    whatToBring: [...COMMON_BRING, "ID for ferry if required"],
    faq: [
      {
        q: "Is the Fountain of Youth included?",
        a: "Yes—visiting the Fountain of Youth on South Bimini is a featured stop on this tour.",
      },
      {
        q: "Where is lunch served?",
        a: "Lunch is on the south side of Bimini at a local restaurant, included in your package.",
      },
      {
    ...
    gallery: ["/images/new12.jpeg", "/images/img6.jpg", "/images/bi12.jpeg"],
  },
  {
